...
public abstract class BaseMusicActivity<P extends BasePresenter<?>> extends BaseActivity<P> implements PropertyChangeListener {
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder binder) {
            ...
            if (player != null) {
                player.addPlayerObserver(BaseMusicActivity.this);
                isBound = true;
                playerBound(player);
            }
        }
    ...
    private void showNeedPermissionDialog() {
        new MaterialAlertDialogBuilder(this, R.style.AnimationDialog)
                ...
                .setMessage(getString(R.string.need_permission_to_access_music))
